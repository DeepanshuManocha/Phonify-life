            ...
            if (foundHit)
            {
                ...
                else
                {
                    ...
                    if(count<1)
                    {
                        ...
                        spawnObject = Instantiate(prefab, hit.Pose.position, hit.Pose.rotation);

                        // Compensate for the hitPose rotation facing away from the raycast (i.e.
                        // camera).
                        spawnObject.transform.Rotate(0, _prefabRotation, 0, Space.Self);
                        ...
                        spawnObject.transform.parent = anchor.transform;
